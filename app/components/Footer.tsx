...
const Footer = () => {
  return (
    <>
    <div className='h-auto w-auto p-3 text-center bg-green-500 text-white font-semibold flex flex-col gap-4'>
      <div className='flex items-center justify-center gap-4'>
        ...
        <h2 className='text-black'>All Rights Reserved Copyright&copy; | BlogSite</h2>
    </div>
    </>
  )
}
